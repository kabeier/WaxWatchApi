...
### Changed
- Pinned `pip-audit` installation in dependency audit automation/local parity commands and documented a periodic version-bump maintenance path for deterministic security scans.
